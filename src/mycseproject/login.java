...
public class login extends javax.swing.JFrame {
  ...
  int p=0;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WELCOME TO RUET");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 153, 153));
        jLabel2.setText("PLEASE LOG-IN FIRST");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
                ...
                try
                {
                   ...
                   String s="SELECT * FROM TEACHER WHERE EMAIL='"+email.getText()+"'";
                   ResultSet rs=st.executeQuery(s);
                   while(rs.next())
                   {
                         
                         if (email.getText().equals(rs.getString(2)))
                         {
                             p=1;
                             break;
                         }
                 ...
                 if (p==1)
                 {
                     if (rs.getString(1).equals(name.getText())&&rs.getString(3).equals(pass.getText()))
                     {
                     ...
                     {
                         JOptionPane.showMessageDialog(null,"Please check your name and password");
                     }
                 }
